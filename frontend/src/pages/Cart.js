   ...
   function decreaseQty(item){
    ...
    function placeOrderHandler(){
        ...
        .then(()=>{
            setCartItems([]);
            setComplete(true);
            toast.success("Order Succes!",{autoClose: 2000})
        })
    }
                            ...
                            {cartItems.map((item) => (
                                 ...
                                 <div class="cart-item">
                                     <div class="row">
                                         ...
                                         <Link to={"/product/" +item.product._id} alt={item.product.name}> </Link>
                                         </div>
                                         ...
                                         <div class="col-4 col-lg-1 mt-4 mt-lg-0">
                                             <i id="delete_cart_item" class="fa fa-trash btn btn-danger" onClick={()=> removeItemFromCart(item)}></i>
                                         </div>
      ...
      </Fragment> : (!complete ? <h2 className="msg"> Your Cart is Empty!</h2>
       : <Fragment><h2 className="msg"> Order Completed! </h2>
      <p className="msg"> Your Order has been placed succesfully.</p>
      </Fragment> )
